...
[Offset, ~] = textread(strcat('./ann-ts/timestamps/timestamps', file_name(4:end-4),'.txt'), '%f%s');
input_start = (start_time(value)-Offset(1))/10^6;
input_end = (end_time(value)-Offset(1))/10^6;
display(file_name);
